console.log("Usage of Stella ID and Stella Kit is bound to the Stella Developer & User License Terms. These terms can be found at https://stella.hs.vc/en/terms");
